...
public class GestionObras {
    ...
    public List<Obra> crearobras() {
        ...
        Obra obra1 = new Obra(0000001L, "La gioconda", fecha, 1000000.0f, "77x53", true,0000);
        fecha.set(1503, 06, 23);
        Obra obra2 = new Obra(0000002L, "La noche estrellada", fecha, 2000000.0f, "74x92", true,0001);
        Obra obra3 = new Obra(0000003L, "Las meninas", fecha, 3000000.0f, "318x276", true,0002);
        Obra obra4 = new Obra(0000004L, "La ultima cena", fecha, 4000000.0f, "460x880", true,0003);
        Obra obra5 = new Obra(0000003L, "Las meninas", fecha, 5000000.0f, "318x276", true,0004);
